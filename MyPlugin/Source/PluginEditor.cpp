...
//==============================================================================
MyPluginPluginEditor::MyPluginPluginEditor (MyPluginAudioProcessor* ownerFilter)
...
MyPluginPluginEditor::~MyPluginPluginEditor()
{
...
//==============================================================================
void MyPluginPluginEditor::paint (Graphics& g)
{
...
void MyPluginPluginEditor::resized()
{
...
void MyPluginPluginEditor::timerCallback()
{
    MyPluginAudioProcessor* ourProcessor = getProcessor();
    // float parameter = ourProcessor->getParameter(0);
